# home-hero-visual Specification

## Purpose
Define the earlier compact Orbit Notes home hero visual, including its theme-aware decorative behavior, reduced-motion handling, and SSR-visible HTML/CSS structure.
